...
<html>
	<head>
		...
		<title>Demo Resume | Informatique Athensoft Live Demo</title>	
		...
		<!-- Demo CSS -->
		<link rel="stylesheet" href="${webapp_name}/css/demos/demo-resume.css">

		<!-- Skin CSS -->
		<link rel="stylesheet" href="${webapp_name}/css/skins/skin-resume.css"> 
	...
	<body data-spy="scroll" data-target=".wrapper-spy">
		...
		<!-- Demo -->
		<script src="${webapp_name}/js/demos/demo-resume.js"></script>
